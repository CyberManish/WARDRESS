...
<p align="center">
  <img src="https://img.shields.io/github/license/CyberManish/WARDRESS?style=for-the-badge&color=2e7d32" alt="License">
...
*   **Option A: No-Git Installation (ZIP Download)**
    *Use this if you do not have Git installed. It downloads the repository ZIP archive, extracts it, and executes the installer:*
    ```powershell
    Invoke-WebRequest -Uri "https://github.com/CyberManish/WARDRESS/archive/refs/heads/main.zip" -OutFile "wardress.zip"; Expand-Archive "wardress.zip" -DestinationPath "."; cd WARDRESS-main; powershell -ExecutionPolicy Bypass -File scripts\install.ps1
    ```

*   **Option B: Git-Based Installation**
    *Use this if you have Git installed. It clones the repository and starts the installer:*
    ```powershell
    git clone https://github.com/CyberManish/WARDRESS.git; cd WARDRESS; powershell -ExecutionPolicy Bypass -File scripts\install.ps1
    ```
